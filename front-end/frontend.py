...
# URL de l'API FastAPI — lue depuis l'env Docker (défaut : backend:8000)
# En local hors Docker, surcharger avec BACKEND_URL=http://localhost:8000
_default_backend_url = os.environ.get("BACKEND_URL", "http://backend:8000")
